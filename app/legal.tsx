 ...
 return <div className="page legal">
  ...
  <div className="spread">
   <main className="sheet"><section className="sheet-section"><span className="folio">P</span>
    ...
    <h1>Privacy</h1>
    <p className="lede">Adomeh keeps as little about you as it can: an email address, your membership status, and where you are in the texts.</p>
    ...
    <h3>Institution inquiries</h3><p>If you submit a project inquiry, we collect the contact details, institution, project interests, source-material information, goals, timeline and optional budget you provide. We use these details to assess your project and reply to you. Resend delivers the inquiry to our team’s email inbox.</p>
 ...
 return <div className="page legal">
  ...
  <div className="spread">
   <main className="sheet"><section className="sheet-section"><span className="folio">T</span>
    ...
    <h3>The service</h3><p>Adomeh, at adomeh.com, is operated by {OPERATOR}. It offers an anatomical atlas and a library of classical medical texts. The atlas, the Library, the Structures pages and the About page are open to everyone. Reading any physician’s texts requires an account and an Adam Membership.</p>

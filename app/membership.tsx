...
export default function Membership(){
 ...
 const tiers=[
  ...
  {n:'02',name:['Reader','Edition'],price:`$${PRICE[interval]}`,unit:interval==='year'?'/ year':'/ month',blurb:'The physicians Maimonides read. Hippocrates, Galen and Avicenna’s Canon beside him, in English, on the same body.',rows:[['Everything in Free','Included'],['Hippocrates · Galen',`${held} works`],['Avicenna’s Canon','In English, as translated'],['New physicians as added','Included']],vivid:true,

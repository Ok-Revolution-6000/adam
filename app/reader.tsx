...
export default function Reader({url,onTerm,onNavigate,header}:ReaderProps){
 ...
 return <div className="reader glass" aria-label="Reading pane">
  ...
  <div className="reader-body" ref={body} onClick={click}>
   ...
   {status==='unauthenticated'&&<div className="reader-note"><p><strong>Sign in to read.</strong></p><p>Maimonides is free to read with an account; the other physicians are open to Readers. You will be brought straight back to this chapter.</p><p><button type="button" className="reader-cta" onClick={goSignIn}>Sign in or make an account</button></p></div>}

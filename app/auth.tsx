 ...
 return <div className="page auth">
  ...
  <div className="spread">
   <main className="sheet"><section className="sheet-section"><span className="folio">{mode==='sign-in'?'S':'N'}</span>
    ...
    <p className="lede">{mode==='sign-in'?'Your place in the texts is kept with your account.':'Maimonides is free to read with an account. The other physicians are open to Readers.'}</p>

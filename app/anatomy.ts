...
export interface SceneState {inspectorOpen?:boolean;explode:number;visible:SystemId[];selected:string[];/** Subset of `selected` drawn in the secondary highlight colour (related anatomy, not the structure under discussion). */secondary?:string[];isolate:boolean;view:View;rotate:boolean;reset:number}

 ...
 *
 * 'public' needs nothing, 'free' needs an account, 'all' needs the Adam Membership.
...
/** Avicenna joins the Adam Membership with the Canon in English, translated from the Würzburg Arabic (CC BY-SA 4.0, commercial use allowed). */
export const AUTHOR_TIER:Record<string,Tier>={maimonides:'all',hippocrates:'all',galen:'all',avicenna:'all'};
